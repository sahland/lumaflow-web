(() => {
  const translations = {
    en: {
      ...
      languageLabel: 'Language', languageHint: 'English is available now. Russian is prepared next.', onThisPage: 'On this page', groupStart: 'Start here', groupFundamentals: 'Fundamentals', groupBuild: 'Build an application', sideInstall: 'Install', sideMount: 'Mount an application', sideComposition: 'Compose UI', sideState: 'React to state', sideLayout: 'Build responsive layouts', sideNavigation: 'Navigate and show overlays', sideInspection: 'Inspect a mount', viewGitHub: 'View on GitHub ↗',
